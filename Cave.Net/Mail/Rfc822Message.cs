...
/// <summary>
/// Provides functions for rfc822 email parsing and processing. Multiple additions are made to accept malformed mail messages from
/// providers like gmail (encoding errors, empty multiparts), gmx (bad headers), ...
/// </summary>
public class Rfc822Message
{
    ...
    public Rfc822AddressCollection To
    {
        get
        {
            try { return new("To", HeaderCollection, Encoding); }
            catch { return null; }
        }
    }
    ...
    /// <summary>
    /// Obtains the first part with the specified media type found in the message. This can only be accessed after checking
    /// <see cref="HasPart" />.
    /// </summary>
    /// <returns></returns>
