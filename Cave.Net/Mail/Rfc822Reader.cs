...
public class Rfc822Reader
{
    ...
    public int Position
    {
        ...
        set
        {
            if ((value >= data.Length) || (value < 0)) { throw new ArgumentOutOfRangeException(nameof(value)); }
            position = value;
        }
    }
    ...
    /// <summary>Peeks at the next byte. Result is -1 if no more bytes available.</summary>
    /// <returns></returns>
    ...
    /// <summary>Reads the next byte. Result is -1 if no more bytes available.</summary>
    /// <returns></returns>
    ...
    /// <summary>Reads a string block with the specified length.</summary>
    /// <param name="count"></param>
    /// <returns></returns>
    ...
    /// <summary>Readss a byte block with the specified length.</summary>
    /// <param name="count"></param>
    /// <returns></returns>
