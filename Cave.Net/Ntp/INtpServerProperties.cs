...
{
    /// <summary>
    /// Provides an interface for ntp server properties.
    /// </summary>
    public interface INtpServerProperties
    {
        /// <summary>
        /// Gets a value indicating whether the clock is synchronized (valid, true) or not (invalid, false).
        /// </summary>
        bool Valid { get; }
        ...
        /// <summary>
        /// Gets the Stratum of the clock.
        /// </summary>
        byte Stratum { get; }

        /// <summary>
        /// Gets an eight-bit signed integer indicating the
        ...
        /// <summary>
        /// Gets a 32-bit signed fixed-point number indicating the
        ...
        /// <summary>
        /// Gets a 32-bit unsigned fixed-point number
        ...
        /// <summary>
        /// Gets a 32-bit bitstring identifying the
        ...
        /// <summary>
        /// Gets the time at which the local clock was
