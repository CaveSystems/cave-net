...
namespace Cave.Net.Ntp
{
    ...
    {
        /// <summary>
        /// <see cref="LeapIndicator"/>, <see cref="VersionNumber"/>, <see cref="Mode"/>.
        /// </summary>
        public byte Settings;

        /// <summary>
        /// Gets or sets a two-bit code warning of an impending
        ...
        /// <summary>
        /// Gets or sets an eight-bit signed integer indicating the
        ...
        /// <summary>
        /// Gets or sets a 32-bit signed fixed-point number indicating the
        ...
        /// <summary>
        /// Gets or sets a 32-bit unsigned fixed-point number
        ...
        /// <summary>
        /// Gets or sets a 32-bit bitstring identifying the
        ...
        /// <summary>
        /// Gets or sets the time at which the local clock was
        /// last set or corrected, in 64-bit timestamp format.
        /// </summary>
        public NtpTimestamp ReferenceTimestamp;

        /// <summary>
        /// Gets or sets the time at which the request departed
        /// the client for the server, in 64-bit timestamp format.
        /// </summary>
        public NtpTimestamp OriginateTimestamp;

        /// <summary>
        /// Gets or sets the time at which the request arrived at
        /// the server, in 64-bit timestamp format.
        /// </summary>
        public NtpTimestamp ReceiveTimestamp;

        /// <summary>
        /// Gets or sets the time at which the reply departed the
